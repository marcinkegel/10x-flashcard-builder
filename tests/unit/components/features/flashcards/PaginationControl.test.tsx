...
describe("PaginationControl", () => {
  ...
  it("renders nothing when totalPages is 1", () => {
    const { container } = render(<PaginationControl currentPage={1} totalPages={1} onPageChange={mockOnPageChange} />);
  ...
  it("shows ellipsis correctly for large number of pages", () => {
    render(<PaginationControl currentPage={5} totalPages={10} onPageChange={mockOnPageChange} />);
  ...
  it("disables all buttons when disabled prop is true", () => {
    render(<PaginationControl currentPage={2} totalPages={5} onPageChange={mockOnPageChange} disabled={true} />);
