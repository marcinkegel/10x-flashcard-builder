...
export const LearningSessionContainer: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center h-full max-w-md mx-auto p-6 space-y-8 animate-pulse">
      ...
      <div className="flex flex-col items-center justify-center h-full max-w-md mx-auto p-6 text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="flex flex-col gap-3 w-full">
          {error.type === "empty" ? (
            ...
            <Button onClick={fetchFlashcards} className="w-full h-12 text-lg">
              <RotateCcw className="mr-2 h-5 w-5" /> Spróbuj ponownie
            </Button>
          )}
          <Button onClick={handleExit} variant="outline" className="w-full h-12 text-lg">
  ...
  return (
    <div className="flex flex-col h-full bg-background overflow-hidden">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6 relative overflow-y-auto">
        {currentCard && (
          <div className="w-full max-w-md flex flex-col items-center space-y-10 py-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <StudyCard
