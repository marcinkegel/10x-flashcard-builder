      ...
      {isFlipped ? (
        <div className="flex gap-4 w-full animate-in fade-in slide-in-from-bottom-2 duration-300">
          ...
          <Button 
            ...
            disabled={disabled}
          >
            <span className="mr-2 text-xs opacity-60 bg-white/20 px-2 py-0.5 rounded border border-white/30 shadow-sm">2</span>
            Znam
        ...
        >
          Pokaż odpowiedź
          <span className="ml-2 text-xs opacity-60 bg-white/20 px-2 py-0.5 rounded border border-white/30 shadow-sm ml-4">Spacja</span>
        </Button>
      )}
    </div>
  );
